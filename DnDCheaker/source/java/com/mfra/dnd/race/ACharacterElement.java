...
public abstract class ACharacterElement<K extends Enum<?>> implements
    ...
    protected void appendAvailableFeat(int availableFeat) {
        ...
        if (this.iBasicData.getDescProperty(AFeat.AVAILABLE_FEATS_KEY_NAME) != null) {
            availableFeats = (Integer) this.iBasicData
                    .getDescProperty(AFeat.AVAILABLE_FEATS_KEY_NAME);
        }
        this.iBasicData.putDescProperty(AFeat.AVAILABLE_FEATS_KEY_NAME,
                availableFeats + availableFeat);
    }

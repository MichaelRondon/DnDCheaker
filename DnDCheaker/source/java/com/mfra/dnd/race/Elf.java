...
public class Elf extends ARace {
    ...
    protected void updateAbilities() {
        AbilityManager abilityManager = new AbilityManager(this.checkProperties);
    ...
    protected void updateFeats() {
        MartialWeaponProficiency martialWeaponProficiency = new MartialWeaponProficiency(
                AFeat.FeatName.MARTIAL_WEAPON_PROFICIENCY,
        ...
        martialWeaponProficiency.setElement(WeaponName.SHORTBOW_COMPOSITE, true);
    }

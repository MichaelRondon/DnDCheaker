...
public class AbilityManager extends ACheckManager {
	...
	public void addToAbility(Ability.AbilityName name, int valueToAdd) throws GeneralException {
		if (this.iBasicData.wasCreated()) {
			Object object = this.iBasicData.getDescProperty(DescProperty.AVAILABLE_ABILITY_POINTS.toString());
			...
			this.iBasicData.putDescProperty(DescProperty.AVAILABLE_ABILITY_POINTS.toString(), availablePoints);
		}

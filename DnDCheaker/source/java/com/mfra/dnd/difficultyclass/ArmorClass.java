...
public class ArmorClass extends ADifficultyClass {
     ...
     */
    public ArmorClass(DCKeyName nameElement,
            HashMap<Enum<?>, ACheckeable> checkProperties,
            HashMap<String, Object> descProperties) {
        super(ADifficultyClass.DCKeyName.ARMOR_CLASS, checkProperties,
                descProperties);
    }
    ...
    public int getDifficultyClass() {
        return 10 + this.getArmorBonus() + this.getShieldBonus()
                + this.getSizeModifier() + this.getAbilityModifier();
    }
    ...
    public int getSizeModifier() {
        return ((ARace) this.iBasicData.getDescProperty(ARace.KEY_NAME))
                .getName().getSizeModifier();
    }

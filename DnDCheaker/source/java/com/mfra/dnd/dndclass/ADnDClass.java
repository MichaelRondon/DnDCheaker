...
public abstract class ADnDClass extends ACharacterElement<ADnDClass.DnDClassName>
	 ...
	 * @param iBasicData
	 */
	public ADnDClass(DnDClassName dnDClassName, IBasicData iBasicData) {
	...
	public enum Level {
		...
		*/
		...
		public BigDecimal getMaxNOClassSkillRanks() {
			return new BigDecimal(this.getMaxClassSkillRanks()).divide(new BigDecimal(2));
		}

 ...
 * @param <I>
 */
public abstract class AFeat<I> extends ACharacterElement<AFeat.FeatName>
    ...
    public void setElement(I element, boolean internal) {
        ...
        if (!internal) {
            Integer availableFeats = (Integer) this.iBasicData
                    .getDescProperty(AVAILABLE_FEATS_KEY_NAME);
            --availableFeats;
            this.iBasicData.putDescProperty(AVAILABLE_FEATS_KEY_NAME,
                    availableFeats);
        }
    }

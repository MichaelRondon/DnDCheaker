...
public class SkillManager extends ACheckManager {
     ...
     */
    public void usePoints(int points, Skill.SkillName skillName,
    ...
    public void usePoints(Language language,
        ...
        LanguagesManager languagesManager = (LanguagesManager) descProperties.get(LanguagesManager.LanguagesManagerName.LANGUAGES.toString());
    ...
    private void validLimitOfSkillForLevel(int skillPoints,
            Skill.SkillName skillName, HashMap<String, Object> descProperties) {
        ACheckeable property = this.getProperty(skillName);
        ...
        if (this.isClassSkill(skillName, descProperties)) {
            ...
            testSkillranks = (currentSkillRanks.add((new BigDecimal(skillPoints)).divide(new BigDecimal(
                    2))));

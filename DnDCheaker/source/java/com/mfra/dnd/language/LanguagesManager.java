...
public class LanguagesManager extends
    ...
    public void addBonusLanguage(Language language) {
        if (language != null
                ...
                && (((ADnDClass) this.iBasicData
                        .getDescProperty(ADnDClass.KEY_NAME))
                        .getSetOfBonusLenguages().contains(language) || ((ARace) this.iBasicData
                        .getDescProperty(ARace.KEY_NAME))
                        .getSetOfBonusLenguages().contains(language))) {
    ...
    public void addLanguage(Language language) {
        ...
        if (language.equals(Language.DRUIDIC)
                && !((ADnDClass) this.iBasicData
                        .getDescProperty(ADnDClass.KEY_NAME)).getName().equals(
    ...
    public void setElement() {
        ...
        this.bonusLanguagesPoints = ((Ability) this.iBasicData
    ...
    private void addAutoLanguages() {
        Set<Language> setOfAutoLenguages = ((ARace) this.iBasicData
                .getDescProperty(ARace.KEY_NAME)).getSetOfAutoLenguages();
